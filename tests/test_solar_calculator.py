...
class TestSolarSavingsCalculator(unittest.TestCase):
    ...
    def test_calculate_monthly_energy_savings(self):
        ...
        actual_monthly_energy_savings = self.calculator.calculate_monthly_energy_savings(self.mock_pv_system)
    ...
    def test_calculate_total_energy_savings(self):
        ...
        actual_total_savings = self.calculator.calculate_total_energy_savings(self.mock_pv_system)
    ...
    def test_calculate_new_monthly_payment(self):
        ...
        new_monthly_payment_deficit = self.calculator.calculate_new_monthly_payment(self.mock_pv_system)
        ...
        new_monthly_payment_surplus = self.calculator.calculate_new_monthly_payment(self.mock_pv_system)
    ...
    def test_calculate_new_lifetime_consumption(self):
        ...
        actual_consumption_deficit = self.calculator.calculate_new_lifetime_consumption(self.mock_pv_system)
        ...
        actual_consumption_surplus = self.calculator.calculate_new_lifetime_consumption(self.mock_pv_system)
