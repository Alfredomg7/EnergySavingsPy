class PVModule:
    def __init__(self, capacity, tilt_angle, efficiency, lifespan=25, annual_degradation=0.005):
        ...
        self._tilt_angle = self._validate_tilt_angle(tilt_angle)
        self._efficiency = self._validate_efficiency(efficiency)
        self._lifespan = self._validate_lifespan(lifespan)
        self._annual_degradation = self._validate_annual_degradation(annual_degradation)
    ...
    def _validate_tilt_angle(self, value):
        if not 0 <= value <= 90:
    ...
    def capacity(self, value):
        self._capacity = self._validate_capacity(value)
    ...
    def tilt_angle(self, value):
        self._tilt_angle = self._validate_tilt_angle(value)
    ...
    def lifespan(self, value):
        self._lifespan = self._validate_lifespan(value)
    ...
    def annual_degradation(self, value):
        self._annual_degradation = self._validate_annual_degradation(value)